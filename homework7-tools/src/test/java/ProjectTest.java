...
public class ProjectTest {
    ...
    private static final String MODULE = "homework7";
    ...
    public Object[][] source() {
        return new Object[][]{
                {"models/Ticket.java"},
                {"pages/AbstractPage.java"},
                {"pages/CreateTicketPage.java"},
                {"pages/LoginPage.java"},
                {"pages/MainPage.java"},
                {"pages/SearchTicketPage.java"},
                {"pages/TicketPage.java"}
        };
    }
    ...
    public void testIncludes(String fileName) {
        String file = resourceDir + File.separator + fileName;
        Path filePath = Paths.get(file);
